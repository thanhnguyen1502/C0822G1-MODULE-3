...
<div class="container-fluid">
    ...
    <div class="row mt-2">
        <div class="col-lg-12 d-flex justify-content-center align-items-center">
            <form action="/EmployeeFurama?action=searchEmployee" method="post" class="d-flex">
            ...
            <table id="tableEmployee" class="table">
                ...
                <c:forEach items="${employeeList}" var="employee" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <button type="button"
                                    onclick="location.href='/EmployeeFurama?action=editEmployee&id=${employee.id}'"
                        ...
                        <td>
                            <button type="button" onclick="deleteEmployee('${employee.name}', '${employee.id}')"
