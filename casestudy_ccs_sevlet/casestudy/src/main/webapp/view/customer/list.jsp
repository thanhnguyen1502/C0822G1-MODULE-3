            ...
            <table id="tableCustomer" class="table">
                ...
                <c:forEach items="${customerList}" var="customer" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <button type="button" onclick="deleteCustomer('${customer.name}', '${customer.customerID}')" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalDelete">
        ...
        <form action="/CustomerFurama?action=deleteCustomer" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    Are you sure delete customer: <span id="deleteName" class="fw-bold"></span>
                </div>
