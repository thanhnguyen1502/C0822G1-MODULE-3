    ...
    <div class="row mt-2">
        <div class="col-lg-12 d-flex justify-content-center align-items-center">
            <form action="/CustomerFurama?action=searchCustomer" method="post" class="d-flex">
                <input class="form-control me-2" type="search" name="keySearch" placeholder="nhập tên" aria-label="Search">
                <input class="form-control me-2" type="search" name="keySearch" placeholder="nhập id" aria-label="Search">
                <input class="form-control me-2" type="search" name="keySearch" placeholder="nhập address" aria-label="Search">
        ...
        <div class="col-lg-12">
            <table id="tableCustomer" class="table">
                ...
                <tr class="table-success">
                    ...
                    <th scope="col"></th>
                    <th scope="col">
                        <button onclick="location.href='/CustomerFurama?action=addNewCustomer'" type="button" class="btn btn-success me-2">
                ...
                <c:forEach items="${customerList}" var="customer" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <button type="button" onclick="location.href='/CustomerFurama?action=editCustomer&id=${customer.customerID}'" class="btn btn-secondary">
