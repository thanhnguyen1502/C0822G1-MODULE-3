...
-- Vị trí --
INSERT INTO furama_management.position (id, `name`) 
VALUES ('1', 'Quản Lý'), ('2', 'Nhân Viên');

-- Trình độ --
INSERT INTO furama_management.education_degree (id, `name`) 
VALUES ('1', 'Trung Cấp'),
('2', 'Cao Đẳng'),
('3', 'Đại Học'),
('4', 'Sau Đại Học');
 ...
 -- Bộ phận --
INSERT INTO furama_management.division (id, `name`) 
...
-- Danh sách nhân viên -- 
INSERT INTO furama_management.employee (id, `name`, date_of_birth, id_card, salary, phone_number, email, address, position_id, education_degree_id, division_id)
...
-- Loại khách hàng --
INSERT INTO furama_management.customer_type (id, `name`) 
VALUES ('1', 'Diamond'),
('2', 'Platinium'),
('3', 'Gold'),
('4', 'Silver'),
...
INSERT INTO furama_management.customer (id, customer_type_id, `name`, date_of_birth, gender, id_card, phone_number, email, address) 
...
-- Kiểu thuê --
INSERT INTO furama_management.rengt_type (id, name)
VALUES ('1', 'year'),
('2', 'month'),
('3', 'day'),
('4', 'hour');
...
-- Loại dịch vụ --
INSERT INTO furama_management.facility_type (id, name)
VALUES ('1', 'Villa'),
('2', 'House'),
('3', 'Room');

-- Dịch vụ --
INSERT INTO furama_management.facility (id, name, area, cost, max_people, rent_type_id, facility_type_id, standard_room, description_other_convenience, pool_area, number_of_floor, facility_free)
...
-- Dịch vụ đi kèm --
INSERT INTO furama_management.attach_facility (id, name, cost, unit, status) 
...
-- Hợp đông --
INSERT INTO furama_management.contract (id, start_date, end_date, deposit, employee_id, customer_id, facility_id) 
...
INSERT INTO furama_management.contract_detail (id, amount, contract_id, attach_facility_id)
VALUES ('1', '5', '2', '4'),
('2', '8', '2', '5'),
('3', '15', '2', '6'),
('4', '1', '3', '1'),
